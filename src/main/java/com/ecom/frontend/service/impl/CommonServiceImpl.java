...
//      http://localhost:8082/api/admin/saveCategory
        String url = "http://localhost:8082/api/admin/getAllCategory";
    ...
    public Boolean saveCategory(Category category, MultipartFile file) throws IOException {
        String url = "http://localhost:8082/api/admin/saveCategory";
  ...
  String category1= category.getName().replace(" ","");
    ...
    public Boolean deleteCategory(String id){
        ...
        String url = "http://localhost:8082/api/admin/deleteCategory/{id}";
    ...
    public Category getCategory(String id) {
        ...
        String url = "http://localhost:8082/api/admin/editCategory/{id}";
    ...
    public boolean updateCategory(Category category) {
        ...
        String url = "http://localhost:8082/api/admin/updateCategory";
    ...
    public List<Category> getAllActiveCategory() {
        String url = "http://localhost:8082/api/admin/getAllActiveCategory";
