...
String url = System.getenv("CART_SERVICE") +"api1/addCart";
    ...
    public List<Cart> getCartsByUser(Integer userId) {
       String url = System.getenv("CART_SERVICE") +"api1/getCart?userId={userId}";
    ...
    public Integer getCountCart(Integer userId) {
       String url = System.getenv("CART_SERVICE") +"api1/countProduct?userId={userId}";
        Map<String, Integer> uriVariables = Map.of("userId", userId);
    ...
    public void updateQuantity(String sy, String cid) {
       ...
       String url = System.getenv("CART_SERVICE") +"api1/cartQuantityUpdate?sy={sy}&cid={cid}";
